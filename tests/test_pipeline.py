...
class TestModularRAG(unittest.TestCase):
    ...
    def setUpClass(cls):
        """测试前初始化"""
        console.print("\nStarting Modular RAG Reconstruction Tests")
        # 强制开启调试模式查看详细输出
    ...
    def test_01_ingest_pipeline(self):
        ...
        console.print(f"\nOK: Ingest Pipeline Test Passed: {result['chunks']} chunks inserted.")

    def test_02_chat_pipeline(self):
        """测试 2: 完整的问答流程 (Retriever -> Reranker -> Context -> LLM)"""
        console.print("\n=== Test 02: Chat Pipeline ===")
        ...
        console.print("\nOK: Chat Pipeline Test Passed.")

    def test_03_error_handling(self):
        """测试 3: 异常处理 (不存在的文件)"""
        console.print("\n=== Test 03: Error Handling ===")
